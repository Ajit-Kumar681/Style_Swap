...
import w1 from "../assets/images/img2.jpg";
import w2 from "../assets/images/img3.jpg";
import w3 from "../assets/images/img4.jpg";
import w4 from "../assets/images/img5.jpg";

const data = [
  { id: "w1", title: "Western Dress", image: w1, category: "Western" },
  { id: "w2", title: "Party Wear", image: w2, category: "Western" },
  { id: "w3", title: "Casual Wear", image: w3, category: "Western" },
  { id: "w4", title: "Modern Outfit", image: w4, category: "Western" },
];

const Western = ({ wishlist, toggleWishlist, cart, toggleCart }) => {
  return (
    <>
      <Navbar />
      ...
      <style>{`
        *{box-sizing:border-box;font-family:Segoe UI,sans-serif}
        ...
        .info{position:absolute;bottom:14px;left:14px;color:#0f172a;font-weight:600;font-size:16px;background:rgba(255,255,255,0.9);padding:4px 8px;border-radius:6px;}
      `}</style>

      <div className="page">
        <h1 className="title">Western Collection</h1>
